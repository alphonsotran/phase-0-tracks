...
# Starts loop until 'exit' is typed
while true

  puts "You can type in 'search', 'add, 'delete' to search and modify medicine list. Use 'schedule' to look at drug regimen based on the day. Type 'exit' to close program."
  puts "What would you like to do?"
  user_destination = gets.chomp.downcase
  break if user_destination == "exit"
